...
export class CategoriesComponent implements OnInit {
    ...
    private categoryMap: Map<Category, number>;
    ...
    selectedCategory: Category; // если равно null - по-умолчанию будет выбираться категория 'Все' - задачи любой категории (и пустой в т.ч.)
