...
//@CrossOrigin(origins = "http://localhost:4200") //разрешить для этого ресурса получить данные с backend
public class PriorityController {
    // Доступ к данным из БД
    private PriorityService priorityService;

    //Автоматическое внедрение экземпляра класса через конструктор
    //Не используем @Autowired для переменной класс, так как "Field injection is not recommended"
